import StoicMoodBoard from '../../client/static/stoic-mood-board.webp';
          ...
          <div className='mx-auto max-w-8xl px-6 lg:px-8'>
            <div className='lg:mb-18 mx-auto max-w-3xl text-center'>
              <h1 className='text-4xl font-bold text-gray-900 sm:text-6xl dark:text-white'>
                A <span className='italic'>gentle</span> AI nudge back to what <span className='text-yellow-500'>matters</span> most.
              </h1>
              <p className='mt-6 mx-auto max-w-2xl text-lg leading-8 text-gray-600 dark:text-white'>
                The world is <span className='italic font-bold'>noisy</span>. Your <span className='font-bold'>dreams</span> are not.
              </p>
